...
def station():
    if request.method == 'GET':
        ...
        stations = [station for station in stations if len(station.strip()) != 0]   # 5개미만으로 작성하엿을때 오류안생기도록
...
def cctv_pop():
    if request.method == 'GET':
        ...
        colormaps = [ 'RdPu','Greys', 'Purples', 'Blues', 'Greens', 'Oranges', 'Reds','YlOrBr', 'YlOrRd',
                      'OrRd', 'PuRd', 'BuPu', 'GnBu', 'PuBu', 'YlGnBu', 'PuBuGn', 'BuGn', 'YlGn']       # 제일 첫번째값이 디폴트값 RdPu
